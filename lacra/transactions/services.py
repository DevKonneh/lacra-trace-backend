...
from lacra.common.schemas.base import Pagination
from lacra.common.schemas.errors import NotFound
from lacra.common.utils import get_user_model, paginate_queryset
from lacra.contrib.tasks.users import send_email, send_sms
from lacra.db.enums import GadgetType, TransactionAction, TransactionStatus, TransactionType
from lacra.db.enums.notifications import NotificationType
from lacra.db.enums.transactions import TransactionLocation, TransactionTraceability
from lacra.db.models import Balance, Commodity, ConversionRecipe, Transaction
from lacra.db.storages import TransactionsStorage, UsersStorage
from lacra.notifications.services.notifications import NotificationsService
from lacra.notifications.services.notifications_push import NotificationsPushService
from lacra.transactions.constants import LOCATION_S3_PREFIX
from lacra.transactions.mappers import TransactionsMapper
from lacra.transactions.schemas.dto import ChainLocationBundleDTO, FeatureCollection, TraceabilityCountsDTO
from lacra.transactions.schemas.errors import (
...
from lacra.transactions.schemas.requests import (
...
class TransactionsService:
    ...
    def _send_invite_email(email: str) -> None:
        send_email.delay(
            recipients=[email],
            subject=_("Welcome to LACRA!"),
            message=_("You have been invited to Lacra!"),
        )

    @staticmethod
    def _send_invite_sms(phone: str) -> None:
        send_sms.delay(recipient=phone, message=_("You have been invited to Lacra!"))
