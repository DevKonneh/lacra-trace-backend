...
from lacra.db.enums import TransactionLocation, TransactionStatus, TransactionType
from lacra.db.models import Transaction
from lacra.transactions.schemas.dto import (
...
from lacra.transactions.schemas.errors import LocationFileDownloadError
from lacra.transactions.services import TransactionsService
...
class TestTransactionsChainDownload:
    ...
    def test_location_file_storage_exception_handling(
        ...
        user = UserFactory.create()
        from tests.factories.commodities import CommodityFactory
        from lacra.db.enums import TransactionLocation
    ...
    def test_location_file_error(
        ...
        mocker.patch(
            "lacra.transactions.services.TransactionsService._get_feature_collections",
    ...
    def test_feature_collections_validation_error(
        ...
        mocker.patch("lacra.transactions.services.default_storage.open", side_effect=mock_default_storage_open)
        mocker.patch("lacra.transactions.services.json.loads", return_value={"invalid": "geojson"})
        ...
        mocker.patch(
            "lacra.transactions.schemas.dto.FeatureCollection.model_validate", side_effect=mock_validate_raises
        )
    ...
    def test_get_feature_collections_storage_exception(self) -> None:
        ...
        with patch("lacra.transactions.services.default_storage.open") as mock_open:
    ...
    def test_get_feature_collections_success_with_transaction_id(self) -> None:
        ...
        with patch("lacra.transactions.services.default_storage.open", return_value=mock_file):
            # Act
            collections, succeed_transactions, failed_transactions = TransactionsService._get_feature_collections(
                transactions
            )
