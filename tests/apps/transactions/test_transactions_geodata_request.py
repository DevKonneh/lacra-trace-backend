...
class TestTransactionsGeodataRequest:
    ...
    def test_request_missing_geodata_no_buyer_id(self) -> None:
        ...
        with (
            patch(
                "lacra.notifications.services.notifications.NotificationsService.create_from_transaction"
            ) as mock_create,
            patch("lacra.notifications.services.notifications_push.NotificationsPushService.send_push"),
        ):
            # Act
