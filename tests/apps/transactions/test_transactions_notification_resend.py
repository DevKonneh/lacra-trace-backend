...
from lacra.db.models import Notification
...
class TestTransactionsNotificationResend:
    ...
    def test_push_notification_tasks(
        ...
        mocker.patch("lacra.contrib.tasks.notifications.send_gcm_push.delay", side_effect=mock_gcm_delay)
        mocker.patch("lacra.contrib.tasks.notifications.send_apns_push.delay", side_effect=mock_apns_delay)
