...
from lacra.common.schemas.base import PaginatedDataResponse
from lacra.db.enums.notifications import NotificationStatus, NotificationType
from lacra.notifications.schemas.dto import NotificationDTO
...
class TestNotificationsPushService:
    ...
    def test_send_push_disabled_notification_type(
        ...
        mock_gcm_delay = mocker.patch("lacra.contrib.tasks.notifications.send_gcm_push.delay")
        mock_apns_delay = mocker.patch("lacra.contrib.tasks.notifications.send_apns_push.delay")
