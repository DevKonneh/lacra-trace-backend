...
from lacra.contrib.admin.dashboard import dashboard_callback
...
class TestDashboardAdmin:
    def test_dashboard_callback(self) -> None:
        ...
        # Act
        with patch(
            "lacra.contrib.admin.dashboard.AnalyticsService.get_analytics_data", return_value=mock_analytics_data
        ):
