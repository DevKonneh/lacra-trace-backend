...
class TestNotificationTasks:
    ...
    @patch("lacra.contrib.tasks.notifications.GCMDevice")
    @patch("lacra.contrib.tasks.notifications.NotificationSettings")
    ...
    @patch("lacra.contrib.tasks.notifications.APNSDevice")
    @patch("lacra.contrib.tasks.notifications.NotificationSettings")
    ...
    # @patch("lacra.contrib.tasks.notifications.APNSDevice")
    # @patch("lacra.contrib.tasks.notifications.NotificationSettings")
    # @patch("lacra.contrib.tasks.notifications.Notification")
