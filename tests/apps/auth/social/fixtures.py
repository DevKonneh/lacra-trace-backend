...
from lacra.auth.social.schemas.dto import OAuthUserInfo


@pytest.fixture
def mock_parse_id_token(mocker: MockerFixture) -> MagicMock:
    return mocker.patch("lacra.auth.social.service.OAuthService._parse_id_token")
...
def mock_parse_code(mocker: MockerFixture) -> MagicMock:
    return mocker.patch("lacra.auth.social.service.OAuthService._parse_code")
